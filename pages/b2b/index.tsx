...
const index = () => {
  ...
  return (
    <div>
      ...
      />
      <div onClick={()=>{setVisible(!visible)}} className="text-center text-xl max-w-[1140px] m-auto py-4 border rounded-md hover:bg-slate-200 cursor-pointer shadow-lg">Zatražite pristup B2B platformi<KeyboardArrowDownIcon/></div>
