        ...
        <ul>
          <li>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4">
              {blogData.filter((record)=>record.type == "Bosch" ).map((record, index) => {
                return (
                  <Card 
                  key={index}
                  title={record.title}
...
//               {Records.filter((record) => record.type === "Bosch").map(
//                 (record) => {
//                   return (
//                     <div
