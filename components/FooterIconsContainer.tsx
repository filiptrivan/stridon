...
const FooterItemsContainer = ({translate}:any) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-14">
      <Item Links={PRODUCTS} title="Call centar" translate={translate}/>
      <Item Links={RADNOVREME} title="Radno Vreme" translate={translate}/>
      <Item Links={INFORMACIJE} title="Informacije" translate={translate}/>
      <Item Links={KOMPANIJA} title="Kompanija" translate={translate}/>
    </div>
  );
};
